        ...
        <div class="space-y-6">
          <div v-for="(item, i) in faqList" :key="i"
            ...
            <button @click="toggle(i)"
              ...
              <span :class="{ 'rotate-180': openIndex === i }" class="transform transition-transform text-argan-gold">
            ...
            <div
              :class="['overflow-hidden transition-all duration-300 ease-in-out', openIndex === i ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0']">
...
const faqList = [
  ...
  },
  {
    ...
    answer: "Non, pour le moment nous ne proposons qu'une seule qualité d'huile d'argan : cosmétique. L'huile alimentaire est torréfiée et possède un délicieux goût de noisette. Elle est idéale pour assaisonner vos plats. Suivez-nous sur nos réseaux sociaux pour être informé de son arrivée !",
  },
  {
